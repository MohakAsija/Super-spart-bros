...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
		...
		// whatIsGround layer
		isGrounded = Physics2D.Linecast(_transform.position, groundCheck.position, whatIsGround);		// Set the grounded animation states
		...
		if (isGrounded == false && candoublejump==true && Input.GetButtonDown ("Jump")) {
			_vy = 0f;
			// add a force in the up direction
			_rigidbody.AddForce (new Vector2 (0, jumpForce));
			// play the jump sound
